...
public class Motorbike extends Vehicle implements Ground, Fuel {
    public Motorbike(Colors color, String name, String className, int fuelCapacity, int fuel, int price, Engine engine) {
