...
public class Tram extends Vehicle implements Ground {
    public Tram(Colors color, String name, String className, int fuelCapacity, int fuel, int price, Engine engine) {
