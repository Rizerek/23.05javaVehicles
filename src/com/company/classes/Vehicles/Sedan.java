...
public class Sedan extends Vehicle implements Ground, Fuel {
    public Sedan(Colors color, String name, String className, int fuelCapacity, int fuel, int price, Engine engine) {
